...
Litter <- read.csv(here("Data/Processed/Processed_KEY/NEON_NIWO_Litter_mass_trap_Processed.csv"), stringsAsFactors = TRUE)
...
For example: Does total litter biomass differ among sites at the Niwot Ridge LTER? is the mean of litter biomass different among sites
```{r}
# Wrangle the data
...
#specify data, site location is level
...
#means are not all same, so reject null hypothesis 
...
> reorder the group lists so it's in order like its shown in tukey output
