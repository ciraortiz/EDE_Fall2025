...
# Format sampledate as date instead of character
...
# Gather nutrient data into one column using pivot_longer (creates more rows)
...
#getting rid of NAs in concentration column
...
# Spread nutrient data into separate columns using spread function
...
```{r joining data}
#joining datasets of physical and nutrient data
...
#joinining litter and trap data
...
#using pipe - depth at 0, lakename and month columns, filtering out nas, creating summaries as well
