...
#everything is put in uppercase
toupper(vector2) 
...
matrix1[4, 1] #gives you specific number in row and columb

matrix1[4,  ] #gives you the entire row

matrix1[ , 3] #gives you entire column

matrix1[c(12, 14)] #vector, the 12th and 14th value

matrix1[c(12:14)] #slices - 12th through the 14th values

matrix1[2:4, 1:3] #subslices - from the 2nd to the 4th, and 1st - 3rd
...
#updates the name to Janelle from Maria
list1$name = "Janelle"
