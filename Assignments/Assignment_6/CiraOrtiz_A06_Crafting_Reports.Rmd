...
```{r boxplots, echo=FALSE, fig.align = 'left', fig.cap='Ozone levels by month in 2018', warning = FALSE, fig.height =2.5}
oz18plot<-epa_data %>% 
  filter(Year == 2018) %>% 
  ggplot(aes(
    x = Month,
  ...
  geom_boxplot()+
  labs(title = "Monthly Ozone concentration in 2018",
       x = "Month",
       y= "Concentrations (ug/m^3)")

oz18plot
```

```{r boxplot19, echo=FALSE, fig.align = 'left', fig.cap='Ozone levels by month in 2019', warning = FALSE, fig.height=2.5}
oz19plot<-epa_data %>% 
  filter(Year == 2019) %>% 
  ggplot(aes(
    x = Month,
  ...
  geom_boxplot()+
    labs(title = "Monthly Ozone concentration in 2019",
       x = "Month",
       y= "Concentrations (ug/m^3)")
...
## Git Repository
https://github.com/ciraortiz/EDE_Fall2025

## AI Statement
This report was made without the use of AI. Cira Ortiz, 17 October 2025.
